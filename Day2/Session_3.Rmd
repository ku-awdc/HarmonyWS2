...
[Using `se_prior` and `sp_prior` is optional: you can also put the priors directly into the model code]
...
# And run the model:
results <- run.jags("multipopulation.txt", n.chains=2)
...
```{r}
results_random <- run.jags("multirandom.txt", n.chains=2, method="parallel")
